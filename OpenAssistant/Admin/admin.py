...
# from .models import LinkedSkillsObjects





# # admin.site.register(LinkedSkillsObjects)
# class LinkedSkillsObjectsAdmin(admin.ModelAdmin):
#     fields = ['name', 'urls', 'shown' ] 
#     list_display = ['name', 'urls', 'shown' ] 
#     def __str__(self):
#         return f"{self.name}" 
# admin.site.register(LinkedSkillsObjects, LinkedSkillsObjectsAdmin)
